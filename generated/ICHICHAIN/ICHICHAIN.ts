...
export class ICHICHAIN__getSeriesTokenListResultValue0Struct extends ethereum.Tuple {
  get tokenID(): BigInt {
  ...
  get ticketStatus(): ICHICHAIN__getSeriesTokenListResultValue0TicketStatusStruct {
    return changetype<ICHICHAIN__getSeriesTokenListResultValue0TicketStatusStruct>(
      this[2].toTuple(),
    );
  }
}

export class ICHICHAIN__getSeriesTokenListResultValue0TicketStatusStruct extends ethereum.Tuple {
  get seriesID(): BigInt {
    return this[0].toBigInt();
  }
...
export class ICHICHAIN extends ethereum.SmartContract {
  ...
  getSeriesTokenList(
    seriesID: BigInt,
  ): Array<ICHICHAIN__getSeriesTokenListResultValue0Struct> {
    let result = super.call(
      "getSeriesTokenList",
    ...
    return result[0].toTupleArray<ICHICHAIN__getSeriesTokenListResultValue0Struct>();
  }
  ...
  > {
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      value[0].toTupleArray<ICHICHAIN__getSeriesTokenListResultValue0Struct>(),
    );
  }
